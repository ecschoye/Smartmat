<template>
<header class="bg-white" style="min-width:480px;">
  <nav class="mx-auto flex max-w-7xl items-center p-6 lg:px-8" aria-label="Global">
    ...
    <div class="flex flex-1 space-x-2 items-center justify-end">
      <div class="p-0.5 rounded-md ring-1 min-w-fit ring-inset ring-gray-300 inline-flex items-center">
            ...
            <HeadlessMenuItems class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-md ring-1 ring-black ring-opacity-5 focus:outline-none">
              <div class="py-1">
                <HeadlessMenuItem v-slot="{ active }">
                  <NuxtLink href="/my-profile" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">Rediger Profil</NuxtLink>
                </HeadlessMenuItem>
                <HeadlessMenuItem v-slot="{ active }">
