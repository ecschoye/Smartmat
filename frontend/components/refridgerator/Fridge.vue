<template>
    <div class="border w-1/3 h-full border-black rounded-lg bg-white" id="wrapper">
      <div class="flex justify-center rounded-md shadow-sm w-full m-5" role="group">
        <button
          type="button"
          class="w-36 px-4 py-2 text-sm font-medium text-black border border-black rounded-l-lg hover:bg-gray-900 hover:text-white"
        ...
        <button
          type="button"
          class="w-36 py-2 text-sm font-medium text-black border  border-black rounded-r-md hover:bg-gray-900 hover:text-white"
